...
if __name__ == "__main__":
    ...
    parser.add_argument("--episode",  type=str, help="Episode ID (e.g. IL_EP001)")
    parser.add_argument("--output",   type=str, help="Output MP4 path")
    parser.add_argument("--test",     action="store_true", help="Quick test render")
    ...
    if args.test:
        ...
        result = render_episode(args.episode, out)
        if result:
            print(f"\nOutput: {result}")
        else:
            sys.exit(1)
