...
| **Bonanza** | ✅ Built + wired tonight, dry-run verified end-to-end through the real Python bridge (`lib/bonanza_listing.py`, 19 tests) | ❌ No account/token yet — Josh needs to sign up at bonanza.com | Not live — same shape as Facebook, code is real and tested, just needs `BONANZA_ACCESS_TOKEN` once an account exists |
